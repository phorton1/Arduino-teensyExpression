...
// 2020-09-22 moved newRig to this oldRig so that I could optimize
// "new rig for the looper", while retaining stuff that was sort
// of working (with quantiloop) being the main difference.
...
class rigOld : public expWindow
{
    ...
    private:
        ...
        int  m_last_relative_vol[4];        // quantiloop specific track volumes
