...
//----------------------------
	...
	#define LOOP_CONTROL_BASE_CC   0x65     // TE send: for 0..LOOPER_NUM_CONTROLS the value is the volume control (Looper pedal == 0x67)
	...
	#define TRACK_STATE_BASE_CC    0x14		// TE recv: for 0..3 tracks, value is track state
	#define CLIP_VOL_BASE_CC       0x30		// TE send ONLY: for 4 tracks * 3 clips - value is volume 0..127
	#define CLIP_MUTE_BASE_CC      0x40		// TE send and recv: for 4 tracks * 3 clips - value is mute state
