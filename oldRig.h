...
// Defines to help me understand the "old" rig
// with Softstep II, MPD218, and UsbExpression converter
...
#define GUITAR_VOLUME_CHANNEL       7
...
// Sample Pad
//----------------------------------------
// Programmed on MPD218 as "PROGRAM messages 0..15
//
// Uses "Multi Patches" with the 1st slot assigned to channel 1
// Valume control presumably comes in on the given channel,
// So, the "synth volume" is CHANNEL 1, controller 7
...
#define SYNTH_PATCH_PIANO2          8       // Smooth FM Piano
#define SYNTH_PATCH_ORGAN2          9       // Drawbars Bow
#define SYNTH_PATCH_BRASS2          10      // Mega Motion 3
#define SYNTH_PATCH_STRINGS2        11      // Whispering Pad
#define SYNTH_PATCH_BASS2           12      // Chorus Fretless
#define SYNTH_PATCH_FLUTE1          13      // Psych Flute
#define SYNTH_PATCH_BASS_MINUS      14      // P Bass Finger
